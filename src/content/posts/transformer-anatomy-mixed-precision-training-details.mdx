...
$$\text{relative error} \leq 2^{-7} \approx 0.78\%$$
...
<Benchmark
  ...
  rows={[
    { label: "FP32 (all operations)", value: "1,200 tok/s", delta: "baseline", faster: false },
    { label: "BF16 mixed (standard)", value: "3,400 tok/s", delta: "+183%", faster: true },
    { label: "BF16 + torch.compile", value: "4,100 tok/s", delta: "+242%", faster: true },
    { label: "FP8 mixed (H100)", value: "5,800 tok/s", delta: "+383%", faster: true },
  ]}
/>
