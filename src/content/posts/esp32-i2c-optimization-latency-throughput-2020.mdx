...
<Benchmark
  ...
  columns={["Pattern", "Bytes", "Time (us)", "Reads/s"]}
  rows={[
    { values: ["14x 1-byte reads", "14", "2100", "476"], highlight: false },
    { values: ["1x 14-byte burst", "14", "420", "2380"], highlight: true },
    { values: ["1x 32-byte burst", "32", "760", "1315"], highlight: true },
  ]}
/>
