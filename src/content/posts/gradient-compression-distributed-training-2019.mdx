...
tags: [gradient-compression, distributed-training, communication-efficiency]
---
...
<Benchmark
  ...
  rows={[
    { values: ["Small", "10M", "0.04", "0.28", "0.028s"], highlight: false },
    { values: ["Medium", "100M", "0.4", "2.8", "0.28s"], highlight: false },
    { values: ["Large", "1B", "4", "28", "2.8s"], highlight: false },
    { values: ["XL", "10B", "40", "280", "28s"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Top-K (1%)", "100x", "< 1%", "99%"], highlight: false },
    { values: ["Top-K (5%)", "20x", "< 0.5%", "95%"], highlight: false },
    { values: ["Rand-K (1%)", "100x", "~1.5%", "99%"], highlight: false },
    { values: ["Rand-K (5%)", "20x", "< 1%", "95%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["None", "1x", "0%", "0%", "100%"], highlight: false },
    { values: ["Top-K (1%)", "100x", "99%", "-0.5%", "95%"], highlight: false },
    { values: ["Top-K (5%)", "20x", "95%", "-0.2%", "98%"], highlight: false },
    { values: ["QSGD (8-bit)", "32x", "97%", "-0.3%", "97%"], highlight: false },
    { values: ["Error Feedback", "50x", "98%", "-0.1%", "99%"], highlight: false },
    { values: ["Adaptive", "25x", "96%", "-0.15%", "98%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Large model, slow network", "Top-K (1%)", "Communication bottleneck", "99% reduction"], highlight: false },
    { values: ["Accuracy-critical training", "Error Feedback", "Maintain convergence", "95% reduction, minimal loss"], highlight: false },
    { values: ["Heterogeneous cluster", "Adaptive", "Varying conditions", "Variable, optimized"], highlight: false },
    { values: ["Memory-constrained", "QSGD", "Storage efficiency", "32x reduction"], highlight: false },
    { values: ["Real-time training", "Rand-K", "Uniform updates", "99% reduction"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Forward Pass", "50", "50", "50", "0%"], highlight: false },
    { values: ["Backward Pass", "80", "80", "80", "0%"], highlight: false },
    { values: ["Gradient Compression", "5", "0", "5", "N/A"], highlight: false },
    { values: ["All-Reduce", "150", "150", "3", "98%"], highlight: false },
    { values: ["Total Iteration", "280", "280", "138", "51%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["2017", "1-bit SGD", "32x", "First practical quantization"], highlight: false },
    { values: ["2018", "Top-K Sparsification", "Variable", "Selective gradient transmission"], highlight: false },
    { values: ["2018", "Error Feedback", "Variable", "Bias correction"], highlight: false },
    { values: ["2019", "Adaptive Compression", "Variable", "Dynamic adjustment"], highlight: false },
    { values: ["2019", "Sketching Methods", "10-100x", "Sublinear communication"], highlight: false },
  ]}
/>
