...
<Benchmark
  ...
  rows={[
    { values: ["Kernel Fusion", "Combine operations", "20-40% speedup"], highlight: false },
    { values: ["Precision Calibration", "FP16/INT8 optimization", "2-4x throughput"], highlight: false },
    { values: ["Memory Optimization", "Reduce memory usage", "30-50% reduction"], highlight: false },
    { values: ["Layer Folding", "Eliminate redundant ops", "10-20% speedup"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Linear + GELU + Linear", "0.82ms", "0.31ms", "2.6x"], highlight: false },
    { values: ["LayerNorm + Linear", "0.15ms", "0.08ms", "1.9x"], highlight: false },
    { values: ["Combined FFN Block", "0.97ms", "0.39ms", "2.5x"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["FP32", "45.2ms", "22.1 tok/s", "100%", "0%"], highlight: false },
    { values: ["FP16", "28.7ms", "34.8 tok/s", "50%", "0.1%"], highlight: false },
    { values: ["INT8", "18.3ms", "54.6 tok/s", "25%", "0.8%"], highlight: false },
    { values: ["INT4", "12.1ms", "82.6 tok/s", "12.5%", "2.3%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["BERT-base", "PyTorch", "1", "12.4", "81"], highlight: false },
    { values: ["BERT-base", "TensorRT", "1", "4.2", "238"], highlight: false },
    { values: ["BERT-base", "TensorRT-FP16", "1", "3.1", "323"], highlight: false },
    { values: ["GPT-2", "PyTorch", "1", "28.7", "35"], highlight: false },
    { values: ["GPT-2", "TensorRT", "1", "11.2", "89"], highlight: false },
    { values: ["GPT-2", "TensorRT-FP16", "1", "8.3", "120"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["BERT-base", "2.4GB", "1.8GB", "1.2GB", "50%"], highlight: false },
    { values: ["BERT-large", "4.8GB", "3.2GB", "2.1GB", "56%"], highlight: false },
    { values: ["GPT-2 small", "3.6GB", "2.4GB", "1.8GB", "50%"], highlight: false },
    { values: ["GPT-2 medium", "7.2GB", "4.8GB", "3.2GB", "56%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["64", "2.1", "2.3", "9%"], highlight: false },
    { values: ["128", "3.2", "3.5", "9%"], highlight: false },
    { values: ["256", "5.8", "6.3", "9%"], highlight: false },
    { values: ["512", "11.2", "12.1", "8%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["V100", "100%", "280%", "2.8x"], highlight: false },
    { values: ["T4", "100%", "220%", "2.2x"], highlight: false },
    { values: ["A100", "100%", "320%", "3.2x"], highlight: false },
    { values: ["RTX 3090", "100%", "250%", "2.5x"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Memory bandwidth", "30%", "20-30% slower", "Kernel fusion"], highlight: false },
    { values: ["Small kernels", "25%", "15-25% slower", "Layer fusion"], highlight: false },
    { values: ["Precision mismatch", "15%", "10-20% slower", "Consistent precision"], highlight: false },
    { values: ["Irregular shapes", "20%", "5-15% slower", "Padding to 8-multiple"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Batch inference", "Excellent", "3-5x", "Fixed batch sizes optimal"], highlight: false },
    { values: ["Real-time serving", "Excellent", "2-4x", "Memory constraints"], highlight: false },
    { values: ["Development/prototyping", "Fair", "1-2x", "Build time overhead"], highlight: false },
    { values: ["Research models", "Variable", "1-3x", "Custom operations support"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Linear/Dense", "Yes", "N/A", "Optimized"], highlight: false },
    { values: ["Convolution", "Yes", "N/A", "Optimized"], highlight: false },
    { values: ["Attention", "Yes", "Custom plugins", "Highly optimized"], highlight: false },
    { values: ["Custom activations", "Limited", "Plugin required", "Variable"], highlight: false },
    { values: ["Dynamic control flow", "Limited", "Unroll/rewrite", "Major impact"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["TensorRT 5", "2018", "Basic optimization", "1.5-2x"], highlight: false },
    { values: ["TensorRT 6", "2019", "Dynamic shapes", "Additional 20%"], highlight: false },
    { values: ["TensorRT 7", "2020", "Sparsity support", "Additional 30%"], highlight: false },
    { values: ["TensorRT 8", "2021", "INT8 calibration", "Additional 50%"], highlight: false },
    { values: ["TensorRT-LLM", "2022", "LLM-specific", "Additional 100%+"], highlight: false },
  ]}
/>
