...
<Benchmark
  ...
  rows={[
    { values: ["Dense/Linear", "Y = XW + b", "Direct (matrix mult)", "2 * input_size"], highlight: false },
    { values: ["Conv2D", "Convolution", "Via im2col transform", "2 * kernel_size²"], highlight: false },
    { values: ["Attention", "QK^T, AV", "Multiple GEMMs", "2 * sequence_length"], highlight: false },
    { values: ["RNN", "W_ih * x + W_hh * h", "Multiple GEMMs", "2 * hidden_size"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Intel MKL", "Skylake-X", "2.5 TFLOPS", "90%", "High"], highlight: false },
    { values: ["OpenBLAS", "Skylake-X", "2.2 TFLOPS", "80%", "Medium"], highlight: false },
    { values: ["cuBLAS", "V100", "125 TFLOPS", "95%", "Very High"], highlight: false },
    { values: ["cuBLAS", "T4", "65 TFLOPS", "85%", "High"], highlight: false },
    { values: ["clBLAS", "AMD Vega", "18 TFLOPS", "70%", "Medium"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["512x512x512", "850", "780", "92%", "No"], highlight: false },
    { values: ["1024x1024x1024", "870", "820", "94%", "No"], highlight: false },
    { values: ["2048x2048x2048", "880", "850", "97%", "No"], highlight: false },
    { values: ["4096x512x4096", "820", "750", "91%", "Yes"], highlight: false },
    { values: ["512x4096x4096", "780", "720", "92%", "Yes"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["V100 GPU", "500 GFLOPS", "900 GFLOPS", "80%", "Tensor Cores"], highlight: false },
    { values: ["T4 GPU", "250 GFLOPS", "450 GFLOPS", "80%", "INT8 Quantization"], highlight: false },
    { values: ["Skylake CPU", "50 GFLOPS", "180 GFLOPS", "260%", "AVX-512"], highlight: false },
    { values: ["ARM CPU", "15 GFLOPS", "45 GFLOPS", "200%", "NEON SIMD"], highlight: false },
    { values: ["TPU", "15 TFLOPS", "15 TFLOPS", "0%", "Specialized"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["512x512x512", "0.5", "Memory", "85% of peak"], highlight: false },
    { values: ["1024x1024x1024", "0.5", "Memory", "87% of peak"], highlight: false },
    { values: ["2048x2048x2048", "0.5", "Memory", "88% of peak"], highlight: false },
    { values: ["4096x512x4096", "0.25", "Memory", "75% of peak"], highlight: false },
    { values: ["128x128x8192", "2.0", "Compute", "95% of peak"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Standard dense layers", "BLAS", "Well-optimized, less work", "Best for general use"], highlight: false },
    { values: ["Quantized inference", "Custom", "BLAS doesn't support quantization", "Required for INT8"], highlight: false },
    { values: ["Tensor Core usage", "Custom", "Need specialized code", "2-4x improvement"], highlight: false },
    { values: ["Fused operations", "Custom", "BLAS can't fuse", "Reduces memory"], highlight: false },
    { values: ["Research/prototyping", "BLAS", "Faster development", "Productivity gain"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["2015", "cuBLAS optimizations", "2x improvement", "Immediate"], highlight: false },
    { values: ["2017", "Tensor Core introduction", "4-8x improvement", "2018-2019"], highlight: false },
    { values: ["2018", "Quantized GEMM", "2-4x inference speed", "2019-2020"], highlight: false },
    { values: ["2019", "Sparse GEMM", "Variable", "2020+"], highlight: false },
    { values: ["2019", "Custom kernels for transformers", "1.5-3x improvement", "Ongoing"], highlight: false },
  ]}
/>
