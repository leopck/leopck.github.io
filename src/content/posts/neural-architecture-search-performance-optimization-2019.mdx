...
<Benchmark
  ...
  rows={[
    { values: ["Design Time", "Days", "Weeks", "Time vs Quality"], highlight: false },
    { values: ["Performance", "Expert level", "Better than expert", "Computation vs Result"], highlight: false },
    { values: ["Flexibility", "Low", "High", "Rigidity vs Adaptability"], highlight: false },
    { values: ["Resource Cost", "Low", "Very High", "Cost vs Automation"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["RL-NAS", "1000+ GPU hours", "Very High", "SOTA", "Low"], highlight: false },
    { values: ["DARTS", "20-50 GPU hours", "High", "Near SOTA", "Medium"], highlight: false },
    { values: ["One-Shot", "24-72 GPU hours", "Medium", "Good", "High"], highlight: false },
    { values: ["Random Search", "Variable", "Low", "Below expert", "Low"], highlight: false },
    { values: ["Evolutionary", "500-2000 GPU hours", "High", "SOTA", "Low"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Search Space Size", "Exponential", "High", "Critical"], highlight: false },
    { values: ["Evaluation Cost", "Linear", "Medium", "Critical"], highlight: false },
    { values: ["Memory Management", "Variable", "Low", "Moderate"], highlight: false },
    { values: ["Optimization Complexity", "High", "High", "Significant"], highlight: false },
    { values: ["Discretization Gap", "Low", "High", "Critical"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Mobile Vision", "High", "Medium", "6 months"], highlight: false },
    { values: ["Edge AI", "High", "Medium", "6 months"], highlight: false },
    { values: ["Academic Research", "Medium", "High", "1-2 years"], highlight: false },
    { values: ["Production Systems", "High", "High", "1 year"], highlight: false },
    { values: ["Proof of Concept", "Low", "Low", "Never profitable"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["2016", "Original NAS", "Automated design", "SOTA"], highlight: false },
    { values: ["2017", "ENAS", "Efficiency improvement", "1000x faster"], highlight: false },
    { values: ["2018", "DARTS", "Differentiable search", "100x faster"], highlight: false },
    { values: ["2019", "Proxy tasks, One-shot", "Practical deployment", "10x faster"], highlight: false },
    { values: ["2020+", "Hardware-aware, Morphisms", "Production ready", "Domain specific"], highlight: false },
  ]}
/>
