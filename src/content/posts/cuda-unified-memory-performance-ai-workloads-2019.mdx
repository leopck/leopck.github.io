...
<Benchmark
  ...
  rows={[
    { values: ["Programming Complexity", "High", "Low", "Simplified development"], highlight: false },
    { values: ["Memory Transfer Control", "Explicit", "Automatic", "Less control"], highlight: false },
    { values: ["Memory Allocation", "Separate calls", "Single call", "Cleaner code"], highlight: false },
    { values: ["Migration Overhead", "None", "Runtime", "Potential overhead"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Large dataset", "245 ms", "89 ms", "2.75x"], highlight: false },
    { values: ["Medium dataset", "120 ms", "52 ms", "2.31x"], highlight: false },
    { values: ["Small dataset", "15 ms", "14 ms", "1.07x"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Sequential Read", "900 GB/s (HBM2)", "650 GB/s", "72%"], highlight: false },
    { values: ["Sequential Write", "900 GB/s (HBM2)", "580 GB/s", "64%"], highlight: false },
    { values: ["Random Read", "900 GB/s", "120 GB/s", "13%"], highlight: false },
    { values: ["Random Write", "900 GB/s", "95 GB/s", "11%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["1024x1024", "850", "780", "8.2%"], highlight: false },
    { values: ["2048x2048", "870", "820", "5.7%"], highlight: false },
    { values: ["4096x4096", "880", "850", "3.4%"], highlight: false },
    { values: ["8192x8192", "890", "870", "2.2%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Pascal", "45 GB/s", "High", "6.2/10"], highlight: false },
    { values: ["Volta", "75 GB/s", "Medium", "7.8/10"], highlight: false },
    { values: ["Turing", "90 GB/s", "Low", "8.5/10"], highlight: false },
    { values: ["Ampere", "100 GB/s", "Very Low", "9.2/10"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Cold miss", "45 µs", "100x"], highlight: false },
    { values: ["Warm access", "0.45 µs", "1x"], highlight: false },
    { values: ["Prefetched", "0.55 µs", "1.2x"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Regular access patterns", "Poor", "-15% to -5%", "Low"], highlight: false },
    { values: ["Irregular access patterns", "Excellent", "+5% to +15%", "High"], highlight: false },
    { values: ["Large datasets", "Good", "-5% to +10%", "High"], highlight: false },
    { values: ["Prototyping", "Excellent", "Variable", "Very High"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["CUDA 6.0", "2014", "Initial UM support", "Foundation"], highlight: false },
    { values: ["CUDA 8.0", "2016", "Multi-GPU support", "20% improvement"], highlight: false },
    { values: ["CUDA 9.0", "2017", "Concurrent access", "15% improvement"], highlight: false },
    { values: ["CUDA 10.0", "2018", "Memory advice APIs", "10% improvement"], highlight: false },
    { values: ["CUDA 10.1", "2019", "Enhanced page migration", "12% improvement"], highlight: false },
  ]}
/>
