...
tags: ["transformer", "long-range", "attention", "nlp"]
---
...
<Benchmark
  ...
  rows={[
    { values: ["512", "2.1", "256", "O(n²)"], highlight: false },
    { values: ["1024", "8.2", "1024", "O(n²)"], highlight: false },
    { values: ["2048", "32.5", "4096", "O(n²)"], highlight: false },
    { values: ["4096", "130.2", "16384", "O(n²)"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Traditional Transformer", "512", "512", "128"], highlight: false },
    { values: ["Transformer-XL (512 seg)", "4096", "2048", "96"], highlight: false },
    { values: ["Transformer-XL (1024 seg)", "8192", "4096", "64"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Absolute PE", "62%", "Poor", "Low"], highlight: false },
    { values: ["Learned Absolute PE", "68%", "Moderate", "Medium"], highlight: false },
    { values: ["Relative PE (Transformer-XL)", "78%", "Excellent", "Medium"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["1K tokens", "16", "16", "0%"], highlight: false },
    { values: ["4K tokens", "4", "16", "75%"], highlight: false },
    { values: ["8K tokens", "2", "16", "87.5%"], highlight: false },
    { values: ["16K tokens", "1", "16", "93.75%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Dynamic Allocation", "1.2ms", "High", "100%"], highlight: false },
    { values: ["Pre-allocated Pool", "0.1ms", "None", "115%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Transformer", "24.0", "1.08", "512"], highlight: false },
    { values: ["Transformer-XL", "18.3", "0.99", "3072"], highlight: false },
    { values: ["Our Implementation", "18.1", "0.97", "4096"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["1", "1.0x", "0.15", "0.90"], highlight: false },
    { values: ["4", "1.3x", "0.60", "0.66"], highlight: false },
    { values: ["8", "1.6x", "0.90", "0.43"], highlight: false },
    { values: ["16", "2.0x", "0.95", "0.17"], highlight: false },
  ]}
/>
