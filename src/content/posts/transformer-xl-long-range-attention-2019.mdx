...
{[
  ["512", "2.1", "256", "O(n^2)"],
  ["1024", "8.2", "1024", "O(n^2)"],
  ["2048", "32.5", "4096", "O(n^2)"],
  ["4096", "130.2", "16384", "O(n^2)"]
]}
</Benchmark>
...
2. **Extended attention computation**: O(segment_length x context_length) 
3. **Relative position calculations**: Additional O(context_length^2) term
