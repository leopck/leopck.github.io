...
<Benchmark
  ...
  rows={[
    { values: ["SGD", "1x", "0", "4GB"], highlight: false },
    { values: ["SGD + Momentum", "2x", "1", "8GB"], highlight: false },
    { values: ["Adam", "3x", "2", "12GB"], highlight: false },
    { values: ["AdamW", "3x", "2", "12GB"], highlight: false },
    { values: ["Memory-efficient Adam", "1.5x", "0.5", "6GB"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Standard Adam", "0%", "0%", "Baseline"], highlight: false },
    { values: ["8-bit Adam", "33%", "< 0.5%", "1.05x"], highlight: false },
    { values: ["Blockwise 8-bit", "33%", "< 0.1%", "1.02x"], highlight: false },
    { values: ["Mixed precision", "50%", "< 0.2%", "0.95x"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Standard Adam", "3x model", "Baseline", "Baseline", "Low"], highlight: false },
    { values: ["8-bit Adam", "1x model", "1.05x", "99.5%", "Medium"], highlight: false },
    { values: ["Blockwise 8-bit", "1x model", "1.02x", "99.9%", "High"], highlight: false },
    { values: ["Decoupled", "1.5x model", "0.95x", "100%", "Medium"], highlight: false },
    { values: ["Memory Pool", "1.5x model", "0.98x", "100%", "Low"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Standard Adam", "High", "Low", "Memory capacity"], highlight: false },
    { values: ["Quantized Adam", "Low", "Medium", "Accuracy preservation"], highlight: false },
    { values: ["Decoupled Adam", "High", "Low", "Memory capacity"], highlight: false },
    { values: ["Lazy Adam", "Medium", "Low", "Fragmentation"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Small models (<100M params)", "Standard Adam", "Simplicity, no benefit", "0%"], highlight: false },
    { values: ["Medium models (100M-1B)", "Quantized Adam", "Good balance", "67%"], highlight: false },
    { values: ["Large models (1B+)", "Quantized Adam", "Essential", "67%"], highlight: false },
    { values: ["Memory-constrained", "Quantized/Lazy", "Capacity requirement", "67-80%"], highlight: false },
    { values: ["Accuracy-critical", "Standard", "Preserve precision", "0%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["2014", "Adam introduction", "3x model size", "Excellent"], highlight: false },
    { values: ["2017", "AdamW variant", "3x model size", "Better generalization"], highlight: false },
    { values: ["2018", "8-bit Adam concepts", "1x model size", "Good"], highlight: false },
    { values: ["2019", "Advanced quantization", "0.5-1x model size", "Very Good"], highlight: false },
    { values: ["2020+", "Sophisticated compression", "0.25x model size", "Excellent"], highlight: false },
  ]}
/>
