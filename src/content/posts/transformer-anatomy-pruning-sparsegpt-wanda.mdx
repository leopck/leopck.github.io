...
<Benchmark
  ...
  columns={["Method", "WikiText-2 PPL", "Delta vs Dense"]}
  rows={[
    { values: ["Dense baseline", "5.68", "0%"], highlight: false },
    { values: ["Unstructured 50% (SparseGPT)", "5.97", "+5.1%"], highlight: true },
    { values: ["Unstructured 50% (Wanda)", "6.12", "+7.7%"], highlight: true },
    { values: ["Row-structured 50%", "7.84", "+38%"], highlight: false },
    { values: ["Column-structured 50%", "8.21", "+44.5%"], highlight: false },
    { values: ["Block-structured 50% (64x64)", "6.89", "+21.3%"], highlight: false },
  ]}
  notes="Llama 7B, WikiText-2 perplexity (lower is better). Dense baseline is 0% sparse."
/>
...
<Benchmark
  ...
  columns={["Configuration", "Throughput (tok/s)", "Delta vs Dense"]}
  rows={[
    { values: ["Dense (cuBLAS)", "2,847", "baseline"], highlight: false },
    { values: ["2:4 Sparse (cuSPARSELt)", "4,952", "+73.9%"], highlight: true },
    { values: ["2:4 Sparse + INT8 weights", "7,208", "+153%"], highlight: true },
    { values: ["Unstructured 50% (no HW support)", "2,891", "+1.5%"], highlight: false },
  ]}
  notes="Llama 7B inference throughput on A100 80GB."
/>
...
<Benchmark
  ...
  columns={["Configuration", "Perplexity", "Memory", "Compression"]}
  rows={[
    { values: ["Dense FP16 (baseline)", "5.68", "14.0 GB", "1.0x"], highlight: false },
    { values: ["50% sparse FP16 (Wanda)", "6.12", "7.0 GB", "2.0x"], highlight: true },
    { values: ["Dense INT4 (GPTQ)", "5.85", "3.5 GB", "4.0x"], highlight: true },
    { values: ["50% sparse + INT4", "6.38", "1.75 GB", "8.0x"], highlight: true },
    { values: ["2:4 sparse + INT8", "6.01", "3.5 GB", "4.0x (2x speed)"], highlight: true },
  ]}
  notes="WikiText-2 perplexity. Memory is model weight storage only."
/>
...
<Benchmark
  ...
  columns={["Method", "Perplexity", "Time", "Weight Updates", "Best For"]}
  rows={[
    { values: ["Magnitude pruning", "7.34", "0 min", "None", "Worst quality"], highlight: false },
    { values: ["SparseGPT", "5.97", "5 min", "Hessian-based", "Best quality"], highlight: true },
    { values: ["Wanda", "6.12", "0.5 min", "None", "Best speed/quality"], highlight: true },
    { values: ["Wanda 2:4 N:M", "6.25", "0.5 min", "None", "Best deployment"], highlight: true },
  ]}
/>
