...
<Benchmark
  ...
  rows={[
    { values: ["All-Reduce", "1MB", "12.5", "8.2"], highlight: false },
    { values: ["All-Reduce", "10MB", "14.2", "12.1"], highlight: false },
    { values: ["All-Reduce", "100MB", "15.1", "45.3"], highlight: false },
    { values: ["All-Gather", "1MB", "11.8", "9.1"], highlight: false },
    { values: ["All-Gather", "10MB", "13.6", "15.2"], highlight: false },
    { values: ["Broadcast", "1MB", "16.2", "6.8"], highlight: false },
    { values: ["Broadcast", "10MB", "15.8", "18.7"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["16KB", "8.2 GB/s", "6.1 GB/s", "N/A", "Ring"], highlight: false },
    { values: ["64KB", "11.4 GB/s", "9.8 GB/s", "N/A", "Ring"], highlight: false },
    { values: ["256KB", "14.2 GB/s", "13.1 GB/s", "N/A", "Ring"], highlight: false },
    { values: ["1MB", "15.8 GB/s", "16.2 GB/s", "N/A", "Tree"], highlight: false },
    { values: ["4MB", "16.1 GB/s", "17.8 GB/s", "N/A", "Tree"], highlight: false },
    { values: ["16MB", "16.3 GB/s", "18.1 GB/s", "19.2 GB/s", "CollNet"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["1", "8", "Tree", "150", "95%"], highlight: false },
    { values: ["2", "16", "Hierarchical", "280", "90%"], highlight: false },
    { values: ["4", "32", "Hierarchical", "520", "85%"], highlight: false },
    { values: ["8", "64", "Hierarchical", "950", "80%"], highlight: false },
    { values: ["16", "128", "Hierarchical", "1800", "75%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["4x V100 NVLink", "Tree + Simple protocol", "15-25%", "Medium"], highlight: false },
    { values: ["8x T4 PCIe", "Ring + LL128 protocol", "10-15%", "Low"], highlight: false },
    { values: ["2x A100 NVLink", "CollNet + Tree", "20-40%", "High"], highlight: false },
    { values: ["Mixed hardware", "Ring + Auto protocol", "5-10%", "Low"], highlight: false },
    { values: ["Network training", "Hierarchical + TCP", "Variable", "High"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Suboptimal algorithm", "10-30% slower", "Profiling", "Low"], highlight: false },
    { values: ["Network congestion", "20-50% slower", "Monitoring", "Medium"], highlight: false },
    { values: ["Poor topology", "30-60% slower", "Topology analysis", "High"], highlight: false },
    { values: ["Memory fragmentation", "5-15% slower", "Memory profiling", "Medium"], highlight: false },
    { values: ["CPU overload", "15-25% slower", "CPU monitoring", "Low"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["NCCL 1.0", "2016", "Basic collectives", "Foundation"], highlight: false },
    { values: ["NCCL 2.0", "2017", "Multi-node support", "10x scaling"], highlight: false },
    { values: ["NCCL 2.4", "2019", "A100 optimizations", "2x performance"], highlight: false },
    { values: ["NCCL 2.6", "2020", "Ring/tree optimization", "15% improvement"], highlight: false },
    { values: ["NCCL 2.7", "2020", "CollNet support", "25% improvement for A100"], highlight: false },
  ]}
/>
