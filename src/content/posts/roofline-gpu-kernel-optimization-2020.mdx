...
<PerfChart
  ...
  chartData={{
    ...
    series: [
      { label: "Memory سقف (AI·beta)", values: [0.9, 4.5, 18, 72, 144], color: "#3b82f6" },
      { label: "Compute سقف (pi)", values: [125, 125, 125, 125, 125], color: "#ef4444" }
    ]
  }}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Tiling in shared memory", "Bytes down", "AI up (right)"], highlight: true },
    { values: ["Kernel fusion", "Bytes down", "AI up (right)"], highlight: true },
    { values: ["Tensor cores / MMA", "FLOPs/s up", "Ceiling up (up)"], highlight: false },
    { values: ["Quantization", "Bytes down, FLOPs/s up (sometimes)", "Right + up"], highlight: true },
  ]}
/>
