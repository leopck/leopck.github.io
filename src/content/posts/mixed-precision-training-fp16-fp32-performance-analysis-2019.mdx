...
<Benchmark
  ...
  rows={[
    { values: ["Dynamic Range", "65K", "65K", "Variable (scaled)"], highlight: false },
    { values: ["Memory Usage", "Baseline", "50% of FP32", "70% of FP32"], highlight: false },
    { values: ["Compute Speed", "Baseline", "2-4x faster*", "2-3x faster"], highlight: false },
    { values: ["Gradient Issues", "None", "Underflow", "Mitigated"], highlight: false },
    { values: ["Convergence", "Guaranteed", "Unstable", "Stable"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["FP16 TFLOPS", "125", "65", "312", "Peak"], highlight: false },
    { values: ["Tensor TFLOPS", "125", "65", "312", "Mixed Precision"], highlight: false },
    { values: ["FP32 TFLOPS", "15.7", "8.1", "19.5", "Peak"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["BERT-base", "12.8 GB", "7.2 GB", "44%"], highlight: false },
    { values: ["BERT-large", "18.2 GB", "10.8 GB", "41%"], highlight: false },
    { values: ["GPT-2 small", "16.4 GB", "9.6 GB", "41%"], highlight: false },
    { values: ["ResNet-50", "4.2 GB", "2.8 GB", "33%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["BERT-base", "3,840 tok/sec", "9,200 tok/sec", "2.4x"], highlight: false },
    { values: ["BERT-large", "1,280 tok/sec", "3,100 tok/sec", "2.4x"], highlight: false },
    { values: ["GPT-2 small", "2,100 tok/sec", "5,800 tok/sec", "2.8x"], highlight: false },
    { values: ["ResNet-50", "1,800 img/sec", "4,200 img/sec", "2.3x"], highlight: false },
    { values: ["Transformer", "45,000 tok/sec", "110,000 tok/sec", "2.4x"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["ImageNet (Top-1)", "76.1%", "76.0%", "-0.1%"], highlight: false },
    { values: ["SQuAD F1", "93.2", "93.1", "-0.1"], highlight: false },
    { values: ["GLUE Score", "83.7", "83.6", "-0.1"], highlight: false },
    { values: ["WikiText-103 PPL", "18.3", "18.5", "+0.2"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["GPU Utilization", "65%", "85%", "20%"], highlight: false },
    { values: ["Memory Bandwidth", "78%", "88%", "10%"], highlight: false },
    { values: ["Tensor Core Usage", "0%", "92%", "N/A"], highlight: false },
    { values: ["Power Efficiency", "Baseline", "1.4x", "40%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Gradient Overflow", "Training instability", "Loss scaling", "Critical"], highlight: false },
    { values: ["Memory Fragmentation", "Reduced batch sizes", "Memory optimization", "10-15%"], highlight: false },
    { values: ["Tensor Shape Mismatch", "Suboptimal TC usage", "Padding to 8-multiple", "5-10%"], highlight: false },
    { values: ["FP32 Operations", "TC underutilization", "Convert to FP16", "Variable"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Large Transformer models", "Excellent", "2-3x speedup", "Gradient scaling needed"], highlight: false },
    { values: ["Small CNN models", "Good", "1.5-2x speedup", "Memory benefit limited"], highlight: false },
    { values: ["RNN/LSTM models", "Fair", "1.2-1.5x speedup", "Numerical stability"], highlight: false },
    { values: ["Reinforcement Learning", "Good", "2x speedup", "Reward scaling needed"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["FP16", "16", "65K", "Proven", "Wide"], highlight: false },
    { values: ["BF16", "16", "Same as FP32", "Stability", "Newer GPUs"], highlight: false },
    { values: ["FP8", "8", "Limited", "Extreme efficiency", "Research"], highlight: false },
    { values: ["NF4", "4", "Normalized", "Quantization", "Research"], highlight: false },
  ]}
/>
