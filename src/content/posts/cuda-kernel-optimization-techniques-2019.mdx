...
<Benchmark
  ...
  rows={[
    { values: ["Large GEMM", "2.0 ms", "5 us", "0.25%", "No action needed"], highlight: false },
    { values: ["LayerNorm", "50 us", "5 us", "10%", "Fuse with adjacent ops"], highlight: true },
    { values: ["Bias add", "8 us", "5 us", "38%", "Must fuse -- overhead dominates"], highlight: true },
    { values: ["Activation (GELU)", "12 us", "5 us", "29%", "Fuse with preceding GEMM"], highlight: true },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    ...
    { values: ["FP16 FMA (tensor)", "Tensor cores", "~1024 ops/clock", "8x FP32 throughput"], highlight: true },
    { values: ["INT32", "INT units", "64 ops/clock", "Same as FP32"], highlight: false },
    { values: ["exp/log/sin/cos", "SFU (special function)", "16 ops/clock", "4x slower than FMA"], highlight: false },
