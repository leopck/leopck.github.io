...
<Benchmark
  ...
  rows={[
    { values: ["Magnitude Pruning", "Individual weights", "50-90%", "Easy"], highlight: false },
    { values: ["Structured Pruning", "Groups/channels", "30-70%", "Medium"], highlight: false },
    { values: ["Neuron Pruning", "Entire neurons", "20-50%", "Medium"], highlight: false },
    { values: ["Layer Pruning", "Entire layers", "10-30%", "Hard"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["LeNet-300-100", "97.6%", "97.4%", "2.1x", "-0.2%"], highlight: false },
    { values: ["ResNet-50", "76.2%", "75.9%", "1.8x", "-0.3%"], highlight: false },
    { values: ["DenseNet-121", "74.4%", "74.1%", "1.6x", "-0.3%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Channel Pruning", "2x", "1-2%", "1.8x", "Yes"], highlight: false },
    { values: ["Filter Pruning", "2x", "1-2%", "1.7x", "Yes"], highlight: false },
    { values: ["Fine-grained", "2x", "0.5%", "1.2x", "No"], highlight: false },
    { values: ["Block pruning", "1.5x", "0.8%", "1.4x", "Yes"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["BERT-base", "50%", "50%", "45%", "134"], highlight: false },
    { values: ["BERT-large", "50%", "50%", "45%", "183"], highlight: false },
    { values: ["ResNet-50", "50%", "50%", "48%", "12"], highlight: false },
    { values: ["MobileNetV2", "50%", "50%", "47%", "2.1"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["NVIDIA V100", "No", "Minimal", "Dense format"], highlight: false },
    { values: ["NVIDIA A100", "Yes", "2-3x", "Structured sparsity"], highlight: false },
    { values: ["Intel CPUs", "Partial", "1.5-2x", "AVX-512 optimized"], highlight: false },
    { values: ["Specialized chips", "Yes", "5-10x", "Custom sparse kernels"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Cloud inference", "Excellent", "2-5x speedup", "Accuracy validation needed"], highlight: false },
    { values: ["Edge deployment", "Excellent", "5-10x reduction", "Hardware compatibility"], highlight: false },
    { values: ["Real-time apps", "Good", "3-6x speedup", "Latency requirements"], highlight: false },
    { values: ["Research models", "Variable", "1-3x", "Custom architecture support"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["BERT-base", "0.1%", "0.5%", "2.1%", "75%"], highlight: false },
    { values: ["ResNet-50", "0.2%", "0.8%", "3.2%", "80%"], highlight: false },
    { values: ["MobileNetV2", "0.1%", "0.6%", "1.8%", "85%"], highlight: false },
    { values: ["Transformer", "0.3%", "1.1%", "4.2%", "70%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["2015", "Magnitude pruning", "Simple threshold", "1.2-1.5x"], highlight: false },
    { values: ["2016", "Iterative pruning", "Gradual sparsity", "1.5-2x"], highlight: false },
    { values: ["2017", "SNIP", "One-shot pruning", "1.3-1.8x"], highlight: false },
    { values: ["2018", "Lottery Ticket", "Subnetwork identification", "1.8-2.5x"], highlight: false },
    { values: ["2019", "Structured pruning", "Hardware-aware", "2-3x"], highlight: false },
  ]}
/>
