...
<Benchmark
  ...
  rows={[
    { values: ["Registers", "~256 KB/SM", "1 cycle", "Zero-overhead (per-thread)", "Thread"], highlight: true },
    { values: ["Shared Memory", "96 KB/SM", "~20-30 cycles", "~3 TB/s (aggregate)", "Block"], highlight: true },
    ...
    { values: ["Global Memory (HBM2)", "16-32 GB", "~400-600 cycles", "~900 GB/s", "GPU"], highlight: false },
  ]}
/>
