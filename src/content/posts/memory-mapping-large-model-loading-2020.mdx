...
<Benchmark
  ...
  rows={[
    { values: ["< 1", "Direct", "Model size + framework overhead", "< 10s"], highlight: false },
    { values: ["1-4", "Optimized Direct", "Model size + 20%", "10-30s"], highlight: false },
    { values: ["4-16", "Memory Mapping", "Peak usage < model size", "30s-2min"], highlight: false },
    { values: ["16-64", "MM + Partitioning", "Per-device < model size", "2-10min"], highlight: false },
    { values: ["> 64", "Distributed + MM", "Per-device << model size", "10min+"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Transformer", "15%", "85%", "60%"], highlight: false },
    { values: ["CNN", "20%", "90%", "70%"], highlight: false },
    { values: ["RNN", "60%", "95%", "80%"], highlight: false },
    { values: ["MLP", "10%", "80%", "50%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["GPT-2 Large Serving", "45s", "2s", "12.8GB -> 0.8GB", "22.6x speedup"], highlight: false },
    { values: ["BERT Large Resume", "18s", "1s", "3.2GB -> 0.3GB", "18.7x speedup"], highlight: false },
    { values: ["T5-3B Inference", "OOM", "8s", "N/A -> 3.8GB", "Makes possible"], highlight: false },
    { values: ["Multi-Model Serving", "24GB total", "2s each", "12GB -> 4GB", "3x density"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["HDD", "0.15", "Poor", "Hours for large models"], highlight: false },
    { values: ["SATA SSD", "0.6", "Fair", "Minutes for large models"], highlight: false },
    { values: ["NVMe SSD", "3.5", "Good", "Seconds for large models"], highlight: false },
    { values: ["Optane PMEM", "12", "Excellent", "Sub-second for large models"], highlight: false },
    { values: ["DRAM", "50-100", "Best", "Not applicable (direct loading)"], highlight: false },
  ]}
/>
