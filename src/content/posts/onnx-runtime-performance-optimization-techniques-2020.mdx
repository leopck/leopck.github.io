...
tags: ["onnx", "runtime", "optimization"]
---
...
<Benchmark
  ...
  rows={[
    { values: ["Disabled", "1.0x", "0%", "Fast"], highlight: false },
    { values: ["Basic", "1.1-1.3x", "5-10%", "Fast"], highlight: false },
    { values: ["Extended", "1.3-2.0x", "10-20%", "Medium"], highlight: false },
    { values: ["All", "1.5-2.5x", "15-30%", "Slow"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["ResNet-50", "1.2 ms", "0.8 ms", "0.4 ms", "TensorRT"], highlight: false },
    { values: ["BERT-Base", "45 ms", "12 ms", "6 ms", "TensorRT"], highlight: false },
    { values: ["MobileNetV2", "2.1 ms", "1.5 ms", "0.9 ms", "TensorRT"], highlight: false },
    { values: ["SSD-Mobilenet", "35 ms", "28 ms", "18 ms", "TensorRT"], highlight: false },
    { values: ["GPT-2 Small", "120 ms", "45 ms", "25 ms", "TensorRT"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["BERT-Base", "1.4 GB", "0.9 GB", "36%", "+5%"], highlight: false },
    { values: ["ResNet-50", "0.25 GB", "0.18 GB", "28%", "+3%"], highlight: false },
    { values: ["GPT-2 Small", "5.2 GB", "3.1 GB", "40%", "+8%"], highlight: false },
    { values: ["MobileNetV2", "0.15 GB", "0.11 GB", "27%", "+2%"], highlight: false },
    { values: ["Vision Transformer", "2.8 GB", "1.9 GB", "32%", "+6%"], highlight: false },
  ]}
/>
...
class ONNXRuntimeProfiler:
    ...
    def identify_bottlenecks(self, op_stats):
        ...
        for op_name, stats in sorted_ops[:5]:  # Top 5 time-consuming operators
            if stats['total_time_us'] over 1000:  # Only consider if significant
                bottlenecks.append({
                    'operator': op_name,
...
<Benchmark
  ...
  rows={[
    { values: ["Microservice", "8.2", "120", "512", "2.1"], highlight: false },
    { values: ["Model Server", "5.8", "180", "384", "1.5"], highlight: false },
    { values: ["Embedded", "2.1", "85", "256", "0.1"], highlight: false },
    { values: ["Optimized Service", "4.5", "220", "448", "1.8"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Dynamic Shape Support", "Variable", "High", "Model re-design"], highlight: false },
    { values: ["INT8 Quantization Loss", "2-10% accuracy", "Medium", "Calibration"], highlight: false },
    { values: ["TensorRT Engine Building", "Long startup", "Low", "Pre-build engines"], highlight: false },
    { values: ["Memory Constraints", "OOM errors", "Medium", "Model partitioning"], highlight: false },
    { values: ["GPU Compatibility", "Hardware dependency", "Low", "CPU fallback"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["1.0", "April 2019", "Initial release", "Foundation"], highlight: false },
    { values: ["1.1", "June 2019", "TensorRT EP", "2-3x GPU speedup"], highlight: false },
    { values: ["1.2", "October 2019", "Quantization tools", "2x+ for INT8"], highlight: false },
    { values: ["1.3", "January 2020", "OpenVINO EP", "CPU inference boost"], highlight: false },
    { values: ["1.4", "April 2020", "ORT Format Model", "Faster loading"], highlight: false },
    { values: ["1.5", "July 2020", "Epilogue fusion", "Additional optimizations"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Model Serving", "High", "20-50%", "Medium"], highlight: false },
    { values: ["Edge Deployment", "High", "30-100%", "Medium"], highlight: false },
    { values: ["Multi-GPU Inference", "High", "2-5x", "High"], highlight: false },
    { values: ["Legacy Model Deployment", "Medium", "10-30%", "Low"], highlight: false },
    { values: ["Research Prototyping", "Low", "Variable", "Low"], highlight: false },
  ]}
/>
