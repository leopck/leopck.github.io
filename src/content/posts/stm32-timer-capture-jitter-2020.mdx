...
static void tim2_input_capture_init(void) {
  ...
  TIM2->CCMR1 = (1u <under 0);                // CC1S = 01: mapped to TI1
...
static inline float period_us(void) {
  // timer at 84 MHz -over 11.9 ns per tick
...
<PerfChart
  ...
  type="bar"
  chartData={{
    labels: ["1.0us", "1.2us", "1.4us", "1.6us", "1.8us", "2.0us"],
    series: [{
      label: "Count",
...
<Benchmark
  ...
  rows={[
    { values: ["Baseline", "1.6us", "3.2us"], highlight: false },
    { values: ["Raise IRQ priority", "1.4us", "2.3us"], highlight: true },
    { values: ["Shorter ISR (defer work)", "1.4us", "1.8us"], highlight: true },
  ]}
/>
