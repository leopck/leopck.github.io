...
<Benchmark
  ...
  rows={[
    { values: ["CUDA Cores", "5120", "Traditional compute"], highlight: false },
    { values: ["Tensor Cores", "640", "AI acceleration"], highlight: false },
    { values: ["Memory", "16/32GB HBM2", "High bandwidth"], highlight: false },
    { values: ["Bandwidth", "900 GB/s", "Memory-bound ops"], highlight: false },
    { values: ["FP32 TFLOPS", "15.7", "General compute"], highlight: false },
    { values: ["Tensor TFLOPS", "125", "AI workloads"], highlight: false },
    { values: ["NVLink", "2x 25GB/s", "Multi-GPU scaling"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  columns={["Feature", "Value", "Significance"]}
  rows={[
    { values: ["CUDA Cores", "4608", "Traditional compute"], highlight: false },
    { values: ["Tensor Cores", "576", "AI acceleration"], highlight: false },
    { values: ["Memory", "11GB GDDR6", "Consumer-grade"], highlight: false },
    { values: ["Bandwidth", "616 GB/s", "Lower than Volta"], highlight: false },
    { values: ["FP32 TFLOPS", "13.4", "General compute"], highlight: false },
    { values: ["Tensor TFLOPS", "89", "AI workloads"], highlight: false },
    { values: ["RT Cores", "576", "Ray tracing"], highlight: false },
    { values: ["INT8 TOPS", "112", "Inference acceleration"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Volta V100", "BERT Base", "FP16", "7.8", "1200"], highlight: false },
    { values: ["Turing RTX2080Ti", "BERT Base", "FP16", "9.8", "900"], highlight: false },
    { values: ["Turing T4", "BERT Base", "INT8", "8.4", "650"], highlight: false },
    { values: ["Volta V100", "ResNet-50", "INT8", "0.8", "18000"], highlight: false },
    { values: ["Turing RTX2080Ti", "ResNet-50", "INT8", "0.9", "14000"], highlight: false },
    { values: ["Turing T4", "ResNet-50", "INT8", "1.2", "11000"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Volta V100", "Transformer", "95%", "118"], highlight: false },
    { values: ["Turing RTX2080Ti", "Transformer", "90%", "80"], highlight: false },
    { values: ["Volta V100", "CNN (ResNet-50)", "85%", "106"], highlight: false },
    { values: ["Turing RTX2080Ti", "CNN (ResNet-50)", "80%", "71"], highlight: false },
    { values: ["Volta V100", "RNN (LSTM)", "70%", "87"], highlight: false },
    { values: ["Turing RTX2080Ti", "RNN (LSTM)", "65%", "57"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["TensorFlow", "Volta", "9.5", "Excellent"], highlight: false },
    { values: ["TensorFlow", "Turing", "9.0", "Excellent"], highlight: false },
    { values: ["PyTorch", "Volta", "9.0", "Excellent"], highlight: false },
    { values: ["PyTorch", "Turing", "8.5", "Very Good"], highlight: false },
    { values: ["MXNet", "Volta", "8.0", "Good"], highlight: false },
    { values: ["MXNet", "Turing", "7.5", "Good"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Volta V100", "NVLink", "1.85x", "3.5x", "6.2x"], highlight: false },
    { values: ["Turing T4", "PCIe", "1.75x", "2.8x", "4.2x"], highlight: false },
    { values: ["Volta V100", "PCIe", "1.80x", "3.2x", "5.1x"], highlight: false },
    { values: ["Turing RTX2080Ti", "PCIe", "1.70x", "2.6x", "3.8x"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Large Model Training", "Memory & Bandwidth", "9.5", "7.0", "Volta"], highlight: false },
    { values: ["Production Inference", "Throughput & Efficiency", "8.0", "9.5", "Turing"], highlight: false },
    { values: ["Research Flexibility", "Feature Support", "9.0", "8.5", "Volta"], highlight: false },
    { values: ["Budget Deployment", "Cost Efficiency", "6.0", "9.0", "Turing"], highlight: false },
    { values: ["Edge AI", "Power Efficiency", "3.0", "9.5", "Turing"], highlight: false },
    { values: ["Multi-GPU Training", "NVLink Scaling", "9.5", "6.0", "Volta"], highlight: false },
  ]}
/>
