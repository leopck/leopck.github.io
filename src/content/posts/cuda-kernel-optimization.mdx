...
<Benchmark
  ...
  notes="A100-80GB, 4096x4096 matrix"
/>
...
<PerfChart
  title="Optimization Progression (4096x4096 FP32)"
  unit="GB/s"
  data={[
...
// 32x8 threads = 256 threads per block
// Registers per thread: ~24
// Shared memory: 32x33x4 = 4.2KB per block
...
transpose_optimizedunder 32, 8><<<dimGrid, dimBlock>well above(d_out, d_in, N);
```
