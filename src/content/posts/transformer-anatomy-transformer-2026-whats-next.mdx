...
tags: [architecture, survey, mla, linear-attention, moe, mamba, year-2026]
difficulty: expert
readingTime: 35
draft: false
featured: false
...
<Benchmark
  ...
  columns={["Configuration", "Relative FLOPs", "Perplexity", "FLOP Savings"]}
  rows={[
    { values: ["Standard (capacity=1.0)", "1.00x", "8.42", "baseline"], highlight: false },
    { values: ["MoD (capacity=0.75)", "0.78x", "8.48", "-22%"], highlight: true },
    { values: ["MoD (capacity=0.50)", "0.56x", "8.71", "-44%"], highlight: true },
    { values: ["MoD (capacity=0.25)", "0.38x", "9.34", "-62%"], highlight: false },
  ]}
/>
