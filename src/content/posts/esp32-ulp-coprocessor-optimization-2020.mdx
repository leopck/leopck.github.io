...
The ESP32 ULP (Ultra Low Power) coprocessor enables sensor processing during deep sleep at ~150 uA. Optimizing ULP code is critical for battery-powered applications.
...
<Benchmark
  ...
  rows={[
    ...
    { values: ["Power", "~150 uA", "During deep sleep"], highlight: true },
...
// Power consumption: ~150 uA (minimal)
```
...
<Benchmark
  ...
  rows={[
    { values: ["Main CPU (240 MHz)", "100 mA", "1000 samples/s", "100 uJ"], highlight: false },
    { values: ["Main CPU (80 MHz)", "50 mA", "333 samples/s", "150 uJ"], highlight: false },
    { values: ["ULP", "150 uA", "8 samples/s", "18.75 uJ"], highlight: true },
  ]}
/>
...
1. **Ultra-low power**: ~150 uA during deep sleep
