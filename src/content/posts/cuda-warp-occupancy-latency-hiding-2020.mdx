...
<RegisterDiagram
  ...
  fields={[
    ...
    { name: "smsp__warp_issue_stalled_long_scoreboard.pct", offset: 32, width: 32, description: "Percentage of cycles where warps stall waiting for memory. High values (over 30%) suggest more warps could help hide latency." },
    ...
    { name: "sm__throughput.avg.pct_of_peak_sustained_elapsed", offset: 96, width: 32, description: "Overall SM throughput. If this is high (over 80%) despite moderate occupancy, you're already well-optimized." }
  ]}
/>
  ...
  layout={[
    {
      ...
      power: "Memory stalls over 30%, SM active under 70%",
      state: "DRAM bandwidth well below theoretical peak",
      color: "#ef4444"
    },
    {
      name: "Focus Elsewhere",
      power: "SM throughput over 80% of peak",
