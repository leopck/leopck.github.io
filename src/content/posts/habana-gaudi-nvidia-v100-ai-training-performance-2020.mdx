...
<Benchmark
  ...
  rows={[
    { values: ["Tensor Cores", "640 units", "AI acceleration"], highlight: false },
    { values: ["Memory", "16GB HBM2", "High bandwidth"], highlight: false },
    { values: ["Bandwidth", "900 GB/s", "Memory-bound ops"], highlight: false },
    { values: ["FP16 TFLOPS", "125", "Mixed precision training"], highlight: false },
    { values: ["FP32 TFLOPS", "15.7", "Traditional compute"], highlight: false },
    { values: ["NVLink", "6x 25GB/s", "Multi-GPU scaling"], highlight: false },
    { values: ["Power", "300W", "High performance, high power"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["ResNet-50", "PyTorch", "8700", "9200", "5.7%"], highlight: false },
    { values: ["ResNet-101", "PyTorch", "6200", "6500", "4.8%"], highlight: false },
    { values: ["BERT-Base", "TensorFlow", "45 seq/s", "52 seq/s", "15.6%"], highlight: false },
    { values: ["BERT-Large", "TensorFlow", "18 seq/s", "22 seq/s", "22.2%"], highlight: false },
    { values: ["EfficientNet-B0", "PyTorch", "12500", "13200", "5.6%"], highlight: false },
    { values: ["GNMT", "PyTorch", "24000", "26000", "8.3%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["2 GPUs", "95%", "97%", "Small models"], highlight: false },
    { values: ["4 GPUs", "92%", "96%", "Medium models"], highlight: false },
    { values: ["8 GPUs", "90%", "95%", "Large models"], highlight: false },
    { values: ["16 GPUs", "84%", "94%", "Distributed training"], highlight: false },
    { values: ["64 GPUs", "65%", "92%", "Large-scale training"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Research Lab (1-4 GPUs)", "Excellent", "Good", "V100 (mature ecosystem)"], highlight: false },
    { values: ["Production Training (8+ GPUs)", "Good", "Excellent", "Gaudi (TCO)"], highlight: false },
    { values: ["Edge Inference", "Poor", "Fair", "Neither optimal"], highlight: false },
    { values: ["Large-Scale Cloud", "Good", "Excellent", "Gaudi (scaling, cost)"], highlight: false },
    { values: ["Existing CUDA Codebase", "Excellent", "Poor", "V100 (migration cost)"], highlight: false },
    { values: ["Green Computing Initiative", "Fair", "Excellent", "Gaudi (power efficiency)"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Power Consumption", "High (300W)", "Medium (220W)", "V100: Accept as given"], highlight: false },
    { values: ["Memory Capacity", "16GB limit", "32GB advantage", "Both: Work around with parallelism"], highlight: false },
    { values: ["Ecosystem Maturity", "Excellent", "Good", "Gaudi: Improving rapidly"], highlight: false },
    { values: ["Interconnect Cost", "High (NVSwitch)", "Low (Ethernet)", "Both: Plan accordingly"], highlight: false },
    { values: ["Debugging Tools", "Excellent", "Good", "Gaudi: Learning curve"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["2017", "V100 Launch", "15 TFLOPS FP32, Tensor Cores", "Established NVIDIA dominance"], highlight: false },
    { values: ["2018", "T4 Launch", "Inference optimization", "Expanded NVIDIA portfolio"], highlight: false },
    { values: ["2019", "Gaudi Announcement", "New competitor emerges", "Challenged NVIDIA monopoly"], highlight: false },
    { values: ["2020", "Gaudi Production", "Viable alternative", "Increased competition"], highlight: false },
    { values: ["2020", "A100 Announced", "Next-gen NVIDIA", "Response to competition"], highlight: false },
    { values: ["2021+", "Specialized Accelerators", "Diversified market", "More options for users"], highlight: false },
  ]}
/>
