...
<Callout type="danger" title="External Pull-ups">
  External pull-up resistors on GPIOs configured as inputs with internal pull-down create a resistor divider drawing continuous current. A 10k pull-up to 3.3V draws 165uA per GPIO!
</Callout>
