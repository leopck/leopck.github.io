...
Every token position in a training batch costs the same FLOPs. A padding token costs as much to process as a real token. If 30% of your batch is padding, you waste 30% of your compute. At $\$2$/GPU-hour on a 2048-GPU cluster, that is $\$1.2M$ wasted per day of training.
...
<Benchmark
  ...
  baseline="Theoretical maximum (100%)"
  rows={[
    { label: "Naive padding (max_seq_len=4096)", value: "38%", delta: "62% wasted", faster: false },
    { label: "Sorted-batch padding", value: "58%", delta: "42% wasted", faster: false },
    { label: "Sequence packing", value: "98.5%", delta: "1.5% wasted", faster: true },
    { label: "Packing + variable length", value: "99.2%", delta: "0.8% wasted", faster: true },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { label: "No packing (padding)", value: "38.2%", delta: "baseline", faster: false },
    { label: "Random packing", value: "96.8%", delta: "+153%", faster: true },
    { label: "Length-sorted packing", value: "98.1%", delta: "+157%", faster: true },
    { label: "FFD bin packing", value: "99.4%", delta: "+160%", faster: true },
  ]}
/>
...
<Benchmark
  title="Cost to Train 1T Tokens (Llama 7B, 1024x H100 at $2/GPU-hr)"
  metric="Training Cost"
  baseline="FFD Packing"
  rows={[
    { label: "Naive padding", value: "$1,280,000", delta: "+160%", faster: false },
    { label: "Sorted-batch padding", value: "$840,000", delta: "+71%", faster: false },
    { label: "Random packing", value: "$502,000", delta: "+2%", faster: true },
    { label: "FFD packing", value: "$492,000", delta: "baseline", faster: true },
  ]}
/>
