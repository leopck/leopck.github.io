...
publishDate: "2020-05-01" # Add a valid date format expected by your schema
category: "Machine Learning" # Add a relevant category string
tags: ["Transformers", "NLP", "ALiBi", "RoPE"] # Add relevant tags as an array
---
