...
tags: [bert, gpt, architecture, performance]
---
...
<Benchmark
  ...
  rows={[
    { values: ["Attention Type", "Bidirectional", "Causal", "Context richness"], highlight: false },
    { values: ["Training Objective", "Masked LM", "Causal LM", "Task specialization"], highlight: false },
    { values: ["Parallel Processing", "High", "Limited", "Training efficiency"], highlight: false },
    { values: ["Inference Speed", "Fast", "Sequential", "Generation speed"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["BERT-base", "32", "512", "3840", "12.8"], highlight: false },
    { values: ["BERT-large", "16", "512", "1280", "18.2"], highlight: false },
    { values: ["GPT-2 small", "16", "1024", "2100", "16.4"], highlight: false },
    { values: ["GPT-2 medium", "8", "1024", "890", "22.1"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Encoding", "BERT-base", "8.2", "-"], highlight: false },
    { values: ["Encoding", "GPT-2 small", "12.5", "-"], highlight: false },
    { values: ["Generation", "BERT-base", "8.2", "122"], highlight: false },
    { values: ["Generation", "GPT-2 small", "45.3", "22"], highlight: false },
    { values: ["Generation", "GPT-2 medium", "78.2", "13"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["128", "124", "486", "23"], highlight: false },
    { values: ["512", "1984", "7784", "23"], highlight: false },
    { values: ["1024", "7936", "31136", "23"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Question Answering", "92.1 F1", "78.3 F1", "BERT"], highlight: false },
    { values: ["Text Classification", "94.5 Acc", "89.2 Acc", "BERT"], highlight: false },
    { values: ["Text Generation", "72.4 PPL", "68.1 PPL", "GPT"], highlight: false },
    { values: ["Summarization", "38.2 ROUGE", "36.8 ROUGE", "GPT"], highlight: false },
    { values: ["Named Entity Recognition", "91.8 F1", "85.3 F1", "BERT"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["GPU Utilization (training)", "89%", "72%", "BERT"], highlight: false },
    { values: ["Memory Bandwidth Usage", "94%", "68%", "BERT"], highlight: false },
    { values: ["Compute Density", "82%", "87%", "GPT"], highlight: false },
    { values: ["Power Efficiency (W/GFLOP)", "0.12", "0.15", "BERT"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["110M", "BERT-base", "GPT-2 small", "1.0x"], highlight: false },
    { values: ["340M", "BERT-large", "GPT-2 medium", "3.2x"], highlight: false },
    { values: ["1.5B", "RoBERTa", "GPT-2 large", "12.4x"], highlight: false },
    { values: ["175B", "BERT-N", "GPT-3", "2800x"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Classification tasks", "BERT", "Bidirectional context", "10-15% improvement"], highlight: false },
    { values: ["Text generation", "GPT", "Autoregressive nature", "Better quality"], highlight: false },
    { values: ["Question answering", "BERT", "Context understanding", "8-12% improvement"], highlight: false },
    { values: ["Language modeling", "GPT", "Causal generation", "Better perplexity"], highlight: false },
    { values: ["Low-latency inference", "BERT", "Parallel processing", "3-5x faster"], highlight: false },
    { values: ["Long-form generation", "GPT", "Coherent text", "Better quality"], highlight: false },
  ]}
/>
