...
<Benchmark
  ...
  rows={[
    { values: ["Data Parallel", "1B params", "4GB × devices", "2B params"], highlight: false },
    { values: ["Model Parallel", "1B params", "4GB ÷ devices", "∞"], highlight: false },
    { values: ["Pipeline Parallel", "1B params", "2GB", "4B params"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["2", "16", "0.89", "2.1", "1.8x"], highlight: false },
    { values: ["4", "8", "0.75", "1.2", "3.0x"], highlight: false },
    { values: ["8", "4", "0.56", "0.7", "4.5x"], highlight: false },
    { values: ["16", "2", "0.32", "0.5", "5.2x"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Bubble Stalls", "High", "Minimized", "40-60%"], highlight: false },
    { values: ["Memory Usage", "Lower", "Higher", "-20%"], highlight: false },
    { values: ["Communication", "Phased", "Overlapped", "Better"], highlight: false },
    { values: ["Implementation", "Simple", "Complex", "N/A"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["4", "2048", "0.064", "0.128", "12.8"], highlight: false },
    { values: ["8", "4096", "0.256", "0.512", "25.6"], highlight: false },
    { values: ["16", "8192", "1.024", "2.048", "51.2"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["GPipe", "High", "Low", "Medium", "Simple"], highlight: false },
    { values: ["1F1B", "Low", "Medium", "High", "Medium"], highlight: false },
    { values: ["Flush", "Low", "High", "Highest", "Complex"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["# Devices", "< 8", "≥ 8", "Use PipeDream for ≥8"], highlight: false },
    { values: ["Memory", "Constrained", "Adequate", "GPipe for tight memory"], highlight: false },
    { values: ["Dev Complexity", "Low", "High", "GPipe for simplicity"], highlight: false },
    { values: ["Target Perf", "Good", "Best", "PipeDream for max perf"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Stage Imbalance", "30-50% loss", "Medium", "High"], highlight: false },
    { values: ["Small Microbatches", "20-30% loss", "Low", "Medium"], highlight: false },
    { values: ["Slow Comm", "40-60% loss", "High", "High"], highlight: false },
    { values: ["Memory Bound", "10-20% loss", "Medium", "Low"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["2018", "Initial GPipe concept", "Foundation", "Base"], highlight: false },
    { values: ["2019", "PipeDream introduction", "Better scheduling", "15-30%"], highlight: false },
    { values: ["2019", "1F1B scheduling", "Reduced bubbles", "20-40%"], highlight: false },
    { values: ["2020", "Advanced scheduling", "Optimized overlap", "30-50%"], highlight: false },
  ]}
/>
