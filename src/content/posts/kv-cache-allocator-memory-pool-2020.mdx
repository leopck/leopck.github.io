...
<PerfChart
  ...
  chartData={{
    labels: ["8", "16", "32", "64"],
    series: [
      { label: "Overhead (relative)", values: [1.0, 0.6, 0.4, 0.3], color: "#ef4444" },
      { label: "Internal frag (relative)", values: [0.4, 0.6, 0.8, 1.0], color: "#3b82f6" },
    ]
  }}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Contiguous", "65%", "Frequent", "480 ms", "1.0x"], highlight: false },
    { values: ["Paged pool", "94%", "Rare", "180 ms", "1.8x"], highlight: true },
    { values: ["Paged + prefix share", "96%", "Rare", "160 ms", "2.0x"], highlight: true },
  ]}
/>
