...
tags: [deepspeed, zero, memory, optimization, distributed-training]
---
...
<Benchmark
  ...
  rows={[
    { values: ["100M params", "Adam", "4GB", "1.33GB", "67%"], highlight: false },
    { values: ["1B params", "Adam", "40GB", "13.3GB", "67%"], highlight: false },
    { values: ["10B params", "Adam", "400GB", "133GB", "67%"], highlight: false },
    { values: ["100M params", "SGD", "2GB", "1.0GB", "50%"], highlight: false },
    { values: ["1B params", "SGD", "20GB", "10GB", "50%"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Traditional", "4x model", "1.0x", "Baseline"], highlight: false },
    { values: ["ZeRO-1", "2.25x model", "1.8x", "1.8x"], highlight: false },
    { values: ["ZeRO-2", "1.25x model", "3.2x", "3.2x"], highlight: false },
    { values: ["ZeRO-3", "1.0x model", "4.0x", "4.0x"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["1B params", "Traditional", "12GB", "8", "2.5"], highlight: false },
    { values: ["1B params", "ZeRO-2", "3.5GB", "32", "2.2"], highlight: false },
    { values: ["1B params", "ZeRO-3", "1.2GB", "64", "1.8"], highlight: false },
    { values: ["10B params", "Traditional", "120GB", "1", "0.2"], highlight: false },
    { values: ["10B params", "ZeRO-2", "35GB", "4", "0.8"], highlight: false },
    { values: ["10B params", "ZeRO-3", "12GB", "16", "0.6"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Communication Saturation", "High", "Medium", "30-50% slowdown"], highlight: false },
    { values: ["Memory Fragmentation", "Medium", "Low", "10-20% slowdown"], highlight: false },
    { values: ["Load Imbalance", "Medium", "High", "15-25% slowdown"], highlight: false },
    { values: ["Checkpoint Overhead", "Medium", "Medium", "5-15% slowdown"], highlight: false },
    { values: ["Broadcast Overhead", "High", "High", "20-40% slowdown"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Large model, moderate GPUs", "ZeRO-2", "Balance memory/comm", "3x memory efficiency"], highlight: false },
    { values: ["Very large model, fast network", "ZeRO-3", "Max memory efficiency", "4x memory efficiency"], highlight: false },
    { values: ["Limited network, OK memory", "ZeRO-1", "Minimize communication", "2x memory efficiency"], highlight: false },
    { values: ["Budget hardware", "Traditional", "Avoid complexity", "Baseline"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Oct 2019", "ZeRO Introduction", "2-4x improvement", "High"], highlight: false },
    { values: ["Early 2020", "ZeRO-Offload", "Additional 2-3x", "Very High"], highlight: false },
    { values: ["Mid 2020", "ZeRO-Infinity", "CPU-Memory unlimited", "Transformative"], highlight: false },
    { values: ["Late 2020", "Integration in frameworks", "Mainstream adoption", "Ubiquitous"], highlight: false },
  ]}
/>
