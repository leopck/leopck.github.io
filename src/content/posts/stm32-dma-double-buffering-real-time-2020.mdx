...
At 48 kHz audio, you have **20.8 us per sample**. With any DSP, filtering, or compression, you'll get crushed by overhead.
...
<Benchmark
  ...
  rows={[
    { values: ["ADC capture @ 200 kS/s", "High CPU, jitter", "Low CPU, stable", "Often 5-20x less overhead"], highlight: true },
