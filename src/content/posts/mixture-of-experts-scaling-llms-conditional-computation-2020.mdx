...
<Benchmark
  ...
  rows={[
    { values: ["1.3B", "1.3B", "2.6e12", "10.4GB"], highlight: false },
    { values: ["6.7B", "6.7B", "1.3e13", "53.6GB"], highlight: false },
    { values: ["175B", "175B", "3.5e14", "1.4TB"], highlight: false },
    { values: ["1T", "1T", "2.0e15", "8.0TB"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Dense 175B", "175B", "175B", "100%", "175B"], highlight: false },
    { values: ["MoE 175B (64 exp)", "5.6T", "5.4B", "0.1%", "5.6T"], highlight: false },
    { values: ["MoE 175B (128 exp)", "22.4T", "2.7B", "0.01%", "22.4T"], highlight: false },
    { values: ["MoE 175B (256 exp)", "44.8T", "1.4B", "0.003%", "44.8T"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Router Computation", "28.7", "1.8%", "Low"], highlight: false },
    { values: ["Top-K Selection", "3.8", "0.2%", "Negligible"], highlight: false },
    { values: ["Dispatch", "45.2", "2.8%", "Moderate"], highlight: false },
    { values: ["Combination", "42.1", "2.6%", "Moderate"], highlight: false },
    { values: ["Total Routing", "119.8", "7.4%", "Low Overall"], highlight: false },
  ]}
/>
```
...
<Benchmark
  ...
  rows={[
    { values: ["Large language modeling", "Excellent", "Massive capacity scaling", "10-100x capacity increase"], highlight: false },
    { values: ["Multilingual translation", "Excellent", "Language-specific experts", "Per-language specialization"], highlight: false },
    { values: ["Code generation", "Good", "Syntax-specific experts", "Language-specific optimization"], highlight: false },
    { values: ["Small datasets", "Poor", "Insufficient data per expert", "Underfitting risk"], highlight: false },
    { values: ["Real-time inference", "Good", "Constant compute per token", "Predictable latency"], highlight: false },
    { values: ["Edge deployment", "Poor", "Complex routing overhead", "Better served by pruning"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["Routing Instability", "High", "Medium", "20-40% slower convergence"], highlight: false },
    { values: ["Load Imbalance", "High", "Low", "10-25% capacity underutilization"], highlight: false },
    { values: ["Expert Collapsing", "Medium", "High", "15-30% capacity loss"], highlight: false },
    { values: ["Gradient Flow", "Medium", "Medium", "10-20% slower training"], highlight: false },
  ]}
/>
...
<Benchmark
  ...
  rows={[
    { values: ["2017", "Original MoE Paper", "2x", "Research"], highlight: false },
    { values: ["2018", "Sparsely-Gated MoE", "10x", "Research"], highlight: false },
    { values: ["2019", "GShard Framework", "100x", "Research"], highlight: false },
    { values: ["2020", "Production Systems", "1000x", "Industry"], highlight: false },
    { values: ["2021+", "Universal MoE", "10000x", "Cutting-edge"], highlight: false },
  ]}
/>
